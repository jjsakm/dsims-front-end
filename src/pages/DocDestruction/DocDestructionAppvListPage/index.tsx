...
import DocDestructionAppvButton from "@/components/Buttons/DocDestructionAppvButton";
import { useSearchStateHandlers } from "@/hooks/InputStateHandlers/useInputStateHandlers";
import PageStatus from "@/components/PageStatus";

export default function DocDestructionAppvListPage() {
  ...
  const breadcrumbs = "파기문서 관리 > 파기 승인";
  const pageTitle = "파기 승인";
